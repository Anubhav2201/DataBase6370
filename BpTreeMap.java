       ...
       implements Serializable, Cloneable, SortedMap <K, V>
{
    ...
    public SortedMap <K,V> subMap (K fromKey, K toKey)
    {
		...
		do {
			for (int i = 0; i < n.nKeys; i++) {
				if (n.key[i].compareTo(fromKey) >= 0 && n.key[i].compareTo(toKey) < 0)
					subMap.put(n.key[i], (V) n.ref[i]);
			}
    ...
    public static void main (String [] args)
    {
        ...
        BpTreeMap bpt       = new BpTreeMap <Integer, Integer> (Integer.class, Integer.class);
